...
<title>Papeles Nacionales - Centros Historicos</title>
							...
							<div class="widget-body no-padding">
								...
								<table class="table table-striped table-bordered" width="100%">
									<thead>
										...
										<tr>
											<th rowspan="2" style="text-align: center; color: blue;">Codigo</th>
											<th rowspan="2" style="text-align: center; color: blue;">Centro</th>
									...
									<tbody>
										<c:forEach items="${listcomp}" var="compp"
											...
											<tr>
												<c:choose>
													<c:when test="${compp.pcent == '@@@@@'}">
														<td colspan="2"><c:out value="${compp.pcenn}" /></td>
													</c:when>
													<c:otherwise>
														<td><c:out value="${compp.pcent}" /></td>
