		...
		<div class="page-footer">
			<div class="row">
				<div class="col-xs-12 col-sm-6">
					<span class="txt-color-white">Sistema de Informacin 2014</span>
				</div>

				<div class="col-xs-6 col-sm-6 text-right hidden-xs">
					<div class="txt-color-white inline-block">
						<i class="txt-color-blueLight hidden-mobile">Ultima Actividad <i class="fa fa-clock-o"></i> <strong>hace 51 minutos &nbsp;</strong> </i>
