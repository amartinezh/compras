										...
										<div class="well">
											<div class="input-group">
												<form:input class="form-control" placeholder="Codigo Producto"
													type="text" path="pipro" data-autocomplete='${ codproducto }'/>
										...
										<div class="well">
											<div class="input-group">
												<form:input class="form-control" placeholder="Nombre Producto"
													type="text" path="pides" data-autocomplete='${ nombproducto }' />
												<div class="input-group-btn">
													<button class="btn btn-default btn-primary" type="submit">
														<i class="fa fa-search"></i> Consultar
													</button>
								...
								<form:form id="formprovcod" action="${accion3}" method="POST" ModelAttribute="compra"
									...
									<fieldset>
										<div class="well">
											<div class="input-group">
												<form:input class="form-control" placeholder="Codigo Producto"
													type="text" path="pprov" data-autocomplete='${ codproveedor }'/>
												<div class="input-group-btn">
													<button class="btn btn-default btn-primary" type="submit">
														<i class="fa fa-search"></i> Consultar
													</button>
										...
										<div class="well">
											<div class="input-group">
												<form:input class="form-control"
													...
													data-autocomplete='${ nombproveedor }' />
												<div class="input-group-btn">
													<button class="btn btn-default btn-primary" type="submit">
														<i class="fa fa-search"></i> Consultar
													</button>
