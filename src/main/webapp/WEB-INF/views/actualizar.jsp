...
<body class="">
	...
	<header id="header">
		...
		<div class="pull-right">
			...
			<a href="${redireccion}" class="btn btn-labeled btn-default"> <span class="btn-label"><i class="glyphicon glyphicon-chevron-left"></i></span>Regresar </a>
									...
									<fieldset>
										<div class="row">
											<section class="col col-6">
												...
												<form:select path="pmes" items="${user_inicio.meses}" />
											</section>
											<section class="col col-6">
												<label class="label">Año</label>
												<form:select path="pano" items="${user_inicio.anos}" />
											</section>
											<section class="col col-6">
												<label class="label">Compañia</label>
												<form:select path="pcia" items="${user_inicio.cpias}" />
											</section>
											<section class="col col-6">
